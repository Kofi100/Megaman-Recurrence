...
func charge_effect(animated_sprite: AnimatedSprite2D):
	if charge_timer == 0:
		...
		animated_sprite.material.set_shader_parameter("bodycolori", colors.LIGHT_BLUE / 255)
		animated_sprite.material.set_shader_parameter("bodycolorii", colors.DEEP_BLUE / 255)
